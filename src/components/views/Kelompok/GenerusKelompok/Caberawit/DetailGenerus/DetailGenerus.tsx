...
interface PropTypes {
  ...
  onOpenChange: () => void;
  refetchGenerus: () => void;
  selectedId: ICaberawit | null;
  setSelectedId: Dispatch<SetStateAction<ICaberawit | null>>;
}
...
const DetailGenerus = (props: PropTypes) => {
  ...
  useEffect(() => {
    if (selectedId) {
      ...
      setValueUpdateGenerus("waliId", `${selectedId?.waliId}`);
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value, ...field } }) => (
                    <Autocomplete
                      ...
                      variant="bordered"
                      onSelectionChange={onChange}
                      placeholder="Pilih Kelas Jenjang..."
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value, ...field } }) => (
                    <Autocomplete
                      {...field}
                      selectedKey={value ?? ""}
                      defaultItems={dataWali?.data || []}
                      label="Wali Murid"
                      variant="bordered"
                      onSelectionChange={onChange}
                      placeholder="Pilih Wali..."
                      isInvalid={!!errors.waliId}
                      errorMessage={errors.waliId?.message}
                    >
                      {(wali: IUser) => (
                        <AutocompleteItem key={wali.id}>
                          {wali.fullName}
                        </AutocompleteItem>
                      )}
                    </Autocomplete>
